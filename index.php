...
<?php
    			...
    			<p id="affichageVilleTemperature" style="float:left;">'.$ville." ".round($data["main"]["temp"]).' °C</p><br/><br/>
    			<p id="affichagePression" style="float:left;">Pression : '.$data['main']['pressure'].' hPa</p>
    			</div>';
    ...
    <div id="chercherPersonneContainer" class="container my-auto">
    	<div class="row">
    		...
    		<div class="col-12 mx-auto">
                ...
                <div class="input-group chercherMeteoInput">
                    <input id="chercherIdInput" type="text" class="form-control" placeholder="Entrer l'id d'une personne">
                    <span class="input-group-btn">
